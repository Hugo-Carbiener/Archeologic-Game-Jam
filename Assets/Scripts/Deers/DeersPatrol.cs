...
{
    [SerializeField] float viewRangeWhenRun; //Distance � laquelle le renne voit le joueur qui court
    [SerializeField] float viewRangeWhenWalk; //Distance � laquelle le renne voit le joueur qui marche
    [SerializeField] float viewOfPlayer; //Distance � laquelle le joueur voit les rennes
    [SerializeField] float fleeRange; //Distance � laquelle le renne fuit
    [SerializeField] float timeBeforeTired; //Temps avant que le renne s'�puise
    [SerializeField] float timeBeforeFixe; //Temps avant lequelle le renne se remet � suivre son chemin
    ...
    private int currentPoint; //Point � atteindre
